                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :dots="false" :nav="false">
                                    <div class="pt" @click="changeImage(thumb[0])" v-bind:class="thumb[0] == gambar_default ? 'active' : ' '"> 
                                        <img src="img/mickey1.jpg" alt="" />

                                    </div>
                                    <div class="pt"  @click="changeImage(thumb[1])" v-bind:class="thumb[1] == gambar_default ? 'active' : ' '">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changeImage(thumb[2])"  v-bind:class="thumb[2] == gambar_default ? 'active' : ' '">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                  <div class="pt" @click="changeImage(thumb[3])"  v-bind:class="thumb[3] == gambar_default ? 'active' : ' '">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                  <router-link to ="/shopping"> <a href="shopping-cart.html" class="primary-btn pd-cart">Add To Cart</a></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
